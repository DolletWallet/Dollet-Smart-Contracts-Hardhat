...
/// @title StrategyCalculationsL1 contract for calculating strategy-related values
contract StrategyCalculationsL1 is Initializable {
    ...
    /// @dev Initializes the StrategyCalculationsL1 contract
